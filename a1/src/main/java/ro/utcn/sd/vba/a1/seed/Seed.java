...
public class Seed implements CommandLineRunner{
    ...
    public void run(String... args) throws Exception {
            ...
            repositoryFactory.createQuestionRepository().save(
                    new Question(1,"What is java","Hello I am new programmer",generateDate("25-03-2019"),"bogdan"));
            repositoryFactory.createQuestionRepository().save(
                    new Question(2,"Hello I am new","Is anybody here?",generateDate("26-03-2019"),"verdes"));
            repositoryFactory.createAnswerRepository().save(
                    new Answer(1,"Java is a programming language",generateDate("25-03-2019"),1,"verdes"));
            repositoryFactory.createAnswerRepository().save(
                    new Answer(2,"Ok thank you",generateDate("26-03-2019"),1,"bogdan"));
            repositoryFactory.createAnswerRepository().save(
                    new Answer(3,"Hello I am here",generateDate("28-03-2019"),2,"bogdan"));
